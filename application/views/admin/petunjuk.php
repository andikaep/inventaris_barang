  ...
  <div class="box box-primary">
    ...
    <div class="box-body">
      ...
      <div class="question" onclick="toggleAnswer('answer1')">
        ...
        <div id="answer1" class="question-answer" style="display: none;">Pada dashboard menampilkan jumlah data yang dimiliki dari total barang, klasifikasi dan user, semisal ada 3 barang, 9 klasifikasi dan 2 user</div>
      </div>
      <hr> <!-- Garis pemisah -->
      <!-- Pertanyaan 2 -->
      <div class="question" onclick="toggleAnswer('answer2')">
        ...
        <div id="answer2" class="question-answer" style="display: none;">Setiap barang yang ditambahkan akan mengisi klasifikasi barang tertentu, jadi setiap barang akan ditampilkan dengan keterangan klasifikasi barang masing-masing</div>
      </div>
      <hr> <!-- Garis pemisah -->
      <!-- Pertanyaan 3 -->
      <div class="question" onclick="toggleAnswer('answer3')">
        <div class="question-title">
        Detail Klasifikasi Barang
          <button id="toggleButton3" class="toggle-answer">+</button>
        </div>
        <div id="answer3" class="question-answer" style="display: none;">Pada detail klasifikasi barang akan ditampilkan semua barang-barang yang masuk pada klasifikasi tertentu</div>
      </div>
      <hr> <!-- Garis pemisah -->
