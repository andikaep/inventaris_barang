 <header class="main-header">
    ...
    <a href="<?php echo base_url('') ?>" class="logo">
      ...
      <span class="logo-mini"><b>PT IB</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>PT Inventaris Barang</b></span>
    </a>
    ...
    padding: 0;
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url('assetAdmin/dist/img/PasFoto.jpg'); ?>" class="user-image" alt="User Image">
