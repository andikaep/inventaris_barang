...
<td>
    <a class="btn btn-ref" href="<?php echo site_url('pengguna/edit/'.$value->id) ?>"><i class="fa fa-fw fa-edit"></i>Edit</a>
    <a href="#!" onclick="deleteConfirm('<?php echo site_url('pengguna/delete/'.$value->id) ?>')" class="btn btn-mandarin"><i class="fa fa-fw fa-trash"></i>Hapus</a>
</td>
